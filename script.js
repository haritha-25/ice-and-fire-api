...
const inputField = document.createElement("input");// Input Field form search
...
formGroup.appendChild(inputField);// Append input in search box container
...
const bookContainer = createDiv("book", "book mt-5 container");// Searched Book container
